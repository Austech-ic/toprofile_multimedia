        ...
        <div className="flex-1">
          ...
          <div className="py-2 md:py-4 w-[100%] lg:w-[92%] xl:w-[85%]">
            <p className="text-xs md:text-xl lg:text-base xl:text-lg font-josefin tracking-wider leading-relaxed md:leading-8 lg:leading-relaxed">
              Your satisfaction is guaranteed with Toprofile! Our multimedia
              enterprise cuts across equipment rental, audiovisual production,
              videography, TV programming, photography, animation, AI, music,
              live-streaming, graphics, and more.
            </p>
          </div>
        ...
        <div className="flex-1">
          {/* {formSubmitted ? (
            ...
            >
              {({ isSubmitting }) => (
                <Form
                  className="flex flex-col gap-2 md:gap-6 py-5"
                  autoComplete="off"
                >
                  ...
                  <div className="flex items-center justify-center lg:justify-start">
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(90deg, #FF4D03 5.56%, #722B90 96.58%)",
                      }}
